...
@Tag("unit")
class AdminRegistrationCreateServiceInstantiationTest {

    @Test
    void canInstantiateWithMockDependencies() throws Exception {
        Constructor<?> constructor = Arrays.stream(AdminRegistrationCreateService.class.getDeclaredConstructors())
