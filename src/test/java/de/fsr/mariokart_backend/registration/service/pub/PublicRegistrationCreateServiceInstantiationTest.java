...
@Tag("unit")
class PublicRegistrationCreateServiceInstantiationTest {

    @Test
    void canInstantiateWithMockDependencies() throws Exception {
        Constructor<?> constructor = Arrays.stream(PublicRegistrationCreateService.class.getDeclaredConstructors())
