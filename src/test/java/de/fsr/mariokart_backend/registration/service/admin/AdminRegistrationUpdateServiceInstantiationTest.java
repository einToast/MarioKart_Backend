...
@Tag("unit")
class AdminRegistrationUpdateServiceInstantiationTest {

    @Test
    void canInstantiateWithMockDependencies() throws Exception {
        Constructor<?> constructor = Arrays.stream(AdminRegistrationUpdateService.class.getDeclaredConstructors())
