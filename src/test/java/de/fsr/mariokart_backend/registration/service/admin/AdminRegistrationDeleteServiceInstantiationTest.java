...
@Tag("unit")
class AdminRegistrationDeleteServiceInstantiationTest {

    @Test
    void canInstantiateWithMockDependencies() throws Exception {
        Constructor<?> constructor = Arrays.stream(AdminRegistrationDeleteService.class.getDeclaredConstructors())
