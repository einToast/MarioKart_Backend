...
@Tag("unit")
class AdminNotificationCreateServiceInstantiationTest {

    @Test
    void canInstantiateWithMockDependencies() throws Exception {
        Constructor<?> constructor = Arrays.stream(AdminNotificationCreateService.class.getDeclaredConstructors())
