...
@Tag("unit")
class PublicNotificationCreateServiceInstantiationTest {

    @Test
    void canInstantiateWithMockDependencies() throws Exception {
        Constructor<?> constructor = Arrays.stream(PublicNotificationCreateService.class.getDeclaredConstructors())
